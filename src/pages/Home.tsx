      ...
      <div className="min-h-screen">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className={`absolute inset-0 ${
            isDark ? 'bg-gradient-to-br from-gray-800 via-gray-900 to-black' : 'bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50'
          }`}></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className={`rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border ${
        ...
        {/* CTA Section */}
        <section className={`py-20 ${
          isDark ? 'bg-gradient-to-r from-purple-800 to-blue-800' : 'bg-gradient-to-r from-purple-600 to-blue-600'
        }`}>
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className={`px-8 py-4 font-semibold rounded-lg transition-colors duration-200 transform hover:scale-105 ${
                isDark ? 'bg-gray-800 text-purple-300 hover:bg-gray-700' : 'bg-white text-purple-600 hover:bg-gray-100'
              }`}>
